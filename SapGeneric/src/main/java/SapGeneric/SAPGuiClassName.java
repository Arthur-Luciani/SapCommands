...
public class SAPGuiClassName {
    ...
    public static String GuiRadioButtonClassName  = "GuiRadioButton";
    public static String GuiButtonClassName ="GuiButton";
    public static String GuiMenuClassName = "GuiMenu";
    public static String GuiOkCodeFieldClassName = "GuiOkCodeField";
    public static String GuiCheckBoxClassName = "GuiCheckBox";
    public static String GuiLabelClassName = "GuiLabel";
